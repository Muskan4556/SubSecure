    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="bg-white/3 border border-white/8 rounded-xl px-5 py-12 text-center">
          ...
          {days < 90 && (
            <p className="text-[10px] font-mono text-white/15 mt-1.5">
              ...
              >
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    <span className="text-[12px] font-medium text-white/75 group-hover:text-white/90 transition-colors truncate">
                      {sub.name}
                    </span>
                    {urgent && (
                  ...
                  <div className="flex items-center gap-3 mt-0.5">
                    {sub.category && (
                      <span className="text-[9px] font-mono text-white/25">{sub.category}</span>
                    )}
                ...
                <div className="text-right shrink-0">
                  <div className="text-[12px] font-mono text-white/70">
                    ...
                    <span className="text-[9px] text-white/25">/{sub.billingCycle === "MONTHLY" ? "mo" : "yr"}</span>
                  </div>
                  <div className={`text-[10px] font-mono mt-0.5 ${urgent ? "text-amber-400/80" : "text-white/30"}`}>
