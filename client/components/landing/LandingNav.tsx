  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 h-14 border-b border-white/6 bg-[#06090f]/80 backdrop-blur-xl">
      <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-[12px] text-white/40">
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/login"
            className="hidden sm:block text-[12px] text-white/40 hover:text-white/80 transition-colors"
          >
            Sign in
          </Link>
          <Link
